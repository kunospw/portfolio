...
const SplashScreen = () => {
  return (
    <div className="w-full h-full max-w-lg max-h-lg pixel-window-frame">
      <div className="pixel-content-area flex flex-col items-center justify-center text-center text-black relative overflow-hidden">
        <div className="absolute top-16">
          <p className="text-2xl">Welcome to</p>
          <h1 className="text-6xl my-4">Dee's World</h1>
          <p className="text-sm tracking-widest">^ Press Space to start ^</p>
        </div>
